						...
						if (len > 0) {
							...
							for (var i = 0; i < len; i++) {
								...
								if (data[i].ansType == 'check') {
									...
									html += "<td><input type='checkbox' value ='yes' checked></td></tr>";
									}
									else{
										html += "<td><input type='checkbox' value ='no'></td></tr>";
									}
								} else {
									html += "<td><input type='text' value ='"+data[i].answer+"'></td></tr>";
								}
