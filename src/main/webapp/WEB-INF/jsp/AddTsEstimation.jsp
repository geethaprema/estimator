	...
	<div class="content">
		<div class="form-content">
			...
			<div class="form-group row">
				...
				<div class="form-group mx-sm-3 mb-2">
					<input type="text" class="form-control" name="project_name"
						value="${project_Name}" readonly="readonly"> <input
						type="number" class="form-control" name="project_id"
						id="projectId" value="${project_Id}" hidden="true">
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Estimate Name : </label>
				<div class="form-group mx-sm-3 mb-2">
					<input type="text" class="form-control" id="estimateName"
						required="required">
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="form-group mx-sm-3 mb-2">
					<textarea class="form-control" id="description" rows="4" cols="70"
			...
			<div class="form-group row">
				...
				<table id="taskTable" class="table " style="display: none;">
			...
			<button type="button" class="btn btn-warning center"
				onclick="location.href = '/viewProjects?custId=${custId}&customerName=${customer_name}'">Back</button>
			<div class="form-group row">
