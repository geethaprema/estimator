...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#complexity").val("${results.complexity}");
		$("#cloudVendor").val("${results.cloud}");
				...
				<div class="form-group row">
					...
					<div class="form-group mx-sm-3 mb-2">
						<input type="text" class="form-control" name="customerName"
							readonly="readonly" value="${customer_name}">
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="form-group mx-sm-3 mb-2">
						<input type="text" class="form-control" name="projectName"
							readonly="readonly" value="${results.project_name}"><input
							type="number" class="form-control" name="projectId"
							value="${results.project_id}" required="required" hidden="true">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-2 col-form-label">Project Description
						: </label>
					<div class="form-group mx-sm-3 mb-2">
						<textarea class="form-control" name="project_Description" rows="4"
							cols="70">${results.project_Description}</textarea>
					</div>
				</div>
				<div class="form-row">
				...
				<div class="form-group row">
					...
					<div class="form-group mx-sm-3 mb-2">
						<input type="text" class="form-control" name="duration"
							id="duration" value="${results.duration}" readonly="readonly">
					</div>
				</div>
