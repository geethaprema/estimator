		...
		<div class="form-content">
			<form method="post">
				<div class="form-group row">
					<label class="col-sm-2 col-form-label">Track Names: </label>
					<div class="form-group mx-sm-3 mb-2">
					<input type="text" class="form-control" name="question"
							required="required" value = "${data.question}">
						 <input type="text"
							class="form-control" name="question_id" value="${data.question_id}"
							hidden="true">
					</div>
				</div>
				<button type="Submit" class="btn btn-primary" value="/addTSQuestion">Submit</button>
						...
						<c:forEach items="${results}" var="item">
							<tr>
								...
								<td><a type="button" class="btn btn-success"
									href="/editQuestion?question_id=${item.question_id}">Edit </a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
